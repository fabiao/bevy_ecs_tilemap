...
use bevy::render::{primitives::Aabb, render_asset::RenderAssetUsages};
use bevy::{
...
impl RenderChunk2d {
    ...
    pub fn new(
        ...
        Self {
            ...
            transform,
            transform_matrix,
            mesh: Mesh::new(bevy::render::render_resource::PrimitiveTopology::TriangleList, RenderAssetUsages::default()),
            spacing,
            texture_size,
            texture,
            tilemap_id,
